      ...
      context "differing bunny versions" do
        shared_examples "raises an error" do
          it "raises an error" do
            ...
            }.to raise_error MessageDriver::Error, "bunny 0.9.0.rc2 or later is required for the bunny adapter"
          end
        end
        ...
        %w(0.8.0 0.9.0.pre6 0.9.0.pre11 0.9.0.rc1).each do |v|
          context "bunny version #{v}" do
            let(:version) { v }
            include_examples "raises an error"
          end
        end
        %w(0.9.0.rc2 0.9.0.rc3 0.9.0 0.9.1).each do |v|
          context "bunny version #{v}" do
            let(:version) { v }
